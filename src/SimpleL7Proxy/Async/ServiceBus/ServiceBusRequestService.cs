...
namespace SimpleL7Proxy.Async.ServiceBus
{
    ...
    public class ServiceBusRequestService : IHostedService, IServiceBusRequestService, IBatchMessageTransport<ServiceBusMessageBatch, BinaryBatchMessageEnvelope>
    {
