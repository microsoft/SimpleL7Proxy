...
public static class Constants
{
    ...
    public const string HealthDetail = "/healthdetail";
    ...
    public const string VERSION = "2.2.13-TR-GCP";
    ...
    /// </summary>
    public static readonly FrozenSet<string> probes = FrozenSet.Create(Health, HealthDetail, Readiness, Startup, Liveness, ForceGC);
