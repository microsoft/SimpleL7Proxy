...
See [→ LLM Simulator](../../test/LLMSimulator/Readme.md) for the full list of simulated models and error scenarios, and [→ Dummy Backend](../DUMMY_BACKEND.md) for an even simpler mock option.
