...
> **Not sure where to start?** Run the [Failover POC](POC-Failover-configuration.md) first — it exercises the core behavior in under 5 minutes and makes the architecture concrete before you read anything else.
