...
if [[ "$operation" == 'create' ]]; then
	...
	az acr import --subscription "$subscription" --resource-group "$acr_resource_group" --name "$acr_name" --source 'publicnvmacr.azurecr.io/metricsserver:v1.0.0' --image 'metricsserver:v1.0.0' --force
fi
